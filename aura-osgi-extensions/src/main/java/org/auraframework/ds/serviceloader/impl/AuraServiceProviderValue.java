...
/**
 * Wrapper class that helps retain the priority of AuraServiceProvider implementations.
 * AuraServiceProviderValue's are sorted the reverse order of priority property
